...
const Currencyset = () => {
    ...
    capitalize' onSubmit={handleCurrencySubmit}>
                <label htmlFor="currency"
                    className='relative flex justify-center items-center mr-2 font-bold '
                >currency:</label>
                <input type="text" placeholder='usd' ref={currencyRef}
      ...
      outline-0 border border-transparent focus:border-cyan leading-4' />
            ...
            <label className='relative flex justify-center items-center'>
                ...
                <select onClick={handlesort} className='rounded bg-gray-200 text-base pl-2 
        pr-10 py-0.5 leading-4 capitalize focus:outline-0 ' name="sortby" id="">
                ...
                <img src={selectIcon} alt="submit" className='w-[1rem] absolute 
                right-0.5 top-1.5 pointer-events-none    h-auto' />
