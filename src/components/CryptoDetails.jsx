...
const HighLowIndicator = ({ currentPrice, high, low }) => {
    ...
    useEffect(() => {
        let total = high - low;
        let greenZone = (high - currentPrice) / total * 100;
        setGreen(greenZone);
    }, [currentPrice, high, low])
    return (
        <>
            <span className='bg-red rounded-l-lg h-1.5 w-[50%]' style={{ width: `${100 - green}%` }}>&nbsp;</span>
            <span className='bg-green rounded-r-lg h-1.5 w-[50%]' style={{ width: `${green}%` }}>&nbsp;</span>
        </>
    )
}
...
const CryptoDetails = () => {
    ...
    return ReactDOM.createPortal(
        <div className='flex justify-center items-center fixed top-0 w-full h-full bg-gray-200
    bg-opacity-30  backdrop-blur-sm  font-nunito' onClick={close}>
                        ...
                        <div className='flex items-center justify-between h-full w-full p-4'>
                            ...
                            <div className='flex flex-col w-[45%] h-full pr-2'>
                                <div className='flex items-center w-full'>
                                    ...
                                    <h1 className='text-xl font-medium capitalize'>{coinData.name}</h1>
                                    <span className=' text-sm py-0.5 px-2.5 ml-2 bg-cyan text-cyan 
                                 bg-opacity-25 uppercase'>{coinData.symbol}</span>
                                    ...
                                    <div className='flex flex-col w-full '>
                                        <div className='flex justify-between'>
                                            ...
                                            <div className={`text-sm px-1 ml-2 font-medium flex items-center rounded  uppercase bg-opacity-25
                                                ${coinData.market_data.price_change_percentage_24h < 0 ? 'bg-red text-red' : 'bg-green text-green'}
                                                `}>
                                                <span>{Number(coinData.market_data.price_change_percentage_24h).toFixed(2)}%</span>
                                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"
                                                    className={` w-[1rem] ml-0.5
                                                    ${coinData.market_data.price_change_percentage_24h < 0 ? 'fill-red' : 'fill-green rotate-180'}
                                                `}>
                                ...
                                <div className='flex justify-between mt-4 w-full'>
                                    ...
                                    <div className='flex flex-col'>
                                        <span className='text-sm capitalize text-gray-100'>Fully Dilluted Valuation</span>
                                        <h2 className='text-base font-bold'>{
                                            new Intl.NumberFormat('en-IN'
                                                , {
                                                    style: 'currency',
                                ...
                                <div className="flex w-full justify-between mt-4">
                                    ...
                                    <div className='flex flex-col content-start'>
                                        ...
                                        <div className='flex justify-between'>
                                            <div className={`text-sm my-1 px-1 ml-2 font-medium flex items-center rounded  uppercase bg-opacity-25 bg-red text-red`}>
                ...
                >
                  ...
                  >
                    ...
                    <path fill="rgba(0, 0, 0, 0)" d="M0 0h24v24H0z" />
                        ...
                        : 
                        <div className='flex w-full h-full min-h-[60vh] justify-center items-center'>
